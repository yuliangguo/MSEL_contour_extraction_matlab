function [beta,p,lli] = linear2(y,x,w)
...
% Changed by Yuliang Guo, to linear regression
...
% because of quadratic form of error function, it has closed form solution

% sample weights get canceled in H\devE.
beta = (x'*x)\(x'*y);
