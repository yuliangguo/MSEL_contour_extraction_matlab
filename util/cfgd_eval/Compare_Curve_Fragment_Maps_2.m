function [TP_GT_L, TP_CP_L, GT_L, CP_L, match_GT_frags, match_CP_frags, miss_GT_frags, extra_CP_frags, match_select_frags] = Compare_Curve_Fragment_Maps_2(CEM_1, CEM_2, prune_len_thresh, display_image, bgroup_only, cost_thresh, edit_thresh, local_dist)
