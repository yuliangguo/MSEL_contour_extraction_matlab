function [TP_GT_L, TP_CP_L, GT_L, CP_L, match_GT_frags, match_CP_frags, miss_GT_frags, extra_CP_frags, match_select_frags] = Compare_Curve_Fragment_Maps(GT_map_path, CP_map_path, prune_len_thresh, display_image, bgroup_only, cost_thresh, edit_thresh, local_dist)
...
if nargin<5
    cost_thresh = 2; % For pruning out unrelated curve fragments and grouping process 
end
if nargin<5
    edit_thresh = 1.2; % Edit Distance threshold pruning out unqualified matching candidats
end
if nargin<5
    local_dist = 2; % Allowed localization Error
end
