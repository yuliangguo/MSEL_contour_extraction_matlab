function [thresh,cntR,sumR,cntP,sumP] = evaluation_bdry_image_match(inFile,gtFile, prFile, nthresh, maxDist, thinpb)
...
for t = 1:nthresh,
    ...
    eval_image(:,:,2) = eval_image(:,:,2)+miss;
    eval_image(:,:,1) = eval_image(:,:,1)+fp;
    ...
    set(h1, 'PaperPositionMode','auto')
     print(h1,'-djpeg95','-r0',[inFile(1:end-4),'_BGT_s3_match.jpg']);  
end
