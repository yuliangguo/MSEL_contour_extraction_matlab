function boundaryBench_yuliang(imgDir, gtDir, pbDir, outDir, nthresh, maxDist, thinpb)
...
%     evaluation_bdry_image_yuliang(inFile,gtFile, evFile, nthresh, maxDist, thinpb);
   evaluation_bdry_image_inverse(inFile,gtFile, evFile, nthresh, maxDist, thinpb);
%      evaluation_bdry_image_match(inFile,gtFile, evFile, nthresh, maxDist, thinpb);%this function use same same input but output opposite scores
    disp(i);
end
