function boundaryBenchScales(imgDir, gtDir, pbDir, outDir, scale, nthresh, maxDist, thinpb)
...
for i = 1:numel(iids),
    ...
    evaluation_bdry_image_scales(inFile,gtFile, evFile, scale, nthresh, maxDist, thinpb);
    disp(i);
end
