function edgesDemo_TO_cornell_video(src_path, start_frame, end_frame)
...
for i = start_frame:end_frame
    i
    imgFile = [src_path num2str(i, '%06d') '.png'];
...
%     imshow(edgemap)
    ...
    dst_edg_file = [out_path num2str(i, '%06d') edg_ext];
    dst_ori_file = [out_path num2str(i, '%06d') orient_ext];
