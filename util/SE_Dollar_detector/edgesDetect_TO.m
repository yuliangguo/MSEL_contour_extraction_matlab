function [TO_edgemap,TO_orientation,edginfo,inds,segs] = edgesDetect_TO( I, model, th, sigma )
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% modified %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[ TO_edgemap, TO_orientation, edginfo ] = subpix_TO_correction( E,O,th,sigma);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%modified%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% perform nms
