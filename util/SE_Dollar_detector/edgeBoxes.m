...
disp('processing EdgeBoxes Approch')
...
if(~iscell(I)), bbs=edgeBoxesImg(I,model,o); 
else n=length(I);bbs=cell(n,1); 
    for i=1:n
        if i==16
            bbs{i} = [1 1 10 10 0];
            continue;
...
if(all(ischar(I))), Image=imread(I); end
model.opts.nms=0; [E,O]=edgesDetect(Image,model);
[bbs,img,boxImg]=edgeBoxesMex(E,O,o.alpha,o.beta,o.eta,o.minScore,o.maxBoxes,...
