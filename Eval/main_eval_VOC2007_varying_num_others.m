...
cem_path = '../Data/SE_Kokkinos_VOC2007/';
edge_path = '../Data/SE_SEL_VOC2007/edges/';
...
prefix = 'SE_Kokkinos_VOC2007_eval_vary_num_';
...
for i = 1:length(img_files)
    ...
    for f = 1:length(vary_num)
        ...
        for igt = 1:length(gt_edgemap)
            ...
            [sum_tp_gt, sum_tp_cp, sum_gt, sum_cp] = cfrags_vs_gt_edgemap(CP_CEM{2}, edgemap, gt_edgemap{igt}, maxDist);
