...
beta_src = '../training/';
cem_path = '../Data/TO_SEL_VOC2007/final_curves/';
...
prefix = 'TO_SEL_VOC2007_eval_vary_num_';
...
for i = 1:length(img_files)
    ...
    for c = 1:length(new_cfrags)
        [bg_grad, sat_grad, hue_grad, abs_k, edge_sparsity, wigg, len, mean_conf, area] = curve_fragment_cues(new_cfrags{c}, hsv_img, edgemap);

%         p = 1 / (1 + exp(-([1, bg_grad, sat_grad, hue_grad, abs_k, edge_sparsity, wigg, len, mean_conf, area]-fmean_2)*beta_2'));
