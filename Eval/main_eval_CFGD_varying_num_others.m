...
beta_src = '../training/';
cem_path = '../Data/TO_Kokkinos_CFGD/';
...
prefix = 'TO_Kokkinos_CFGD_eval_vary_num_';
...
vary_num = [1 3 5 7 10 15 20 30 40 60 80 120 160 320 400 500 600 750];
...
%         [bg_grad, sat_grad, hue_grad, abs_k, edge_sparsity, wigg, len] = curve_fragment_cues(new_cfrags{c}, hsv_img, edgemap);
% 
